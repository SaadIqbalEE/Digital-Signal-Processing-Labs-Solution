// MCBSP.h - MCBSP configuration defs for 32-bit data transfers
//
// based on modifications by Tretter and Chassaing-Reay of the default 
// BSL codec configuration function, DSK6713_AIC23_openCodec() 

MCBSP_Config cfgdata32 = {
